  ...
  return (
    <div className='bg-white border-4 border-gray-900 rounded-2xl p-6 flex flex-col items-center w-56 print-card'>
      <div className='flex items-center gap-2 mb-3'>
        <div className='bg-yellow-400 rounded-lg w-7 h-7 flex items-center justify-center'>
          <span className='text-gray-900 font-black text-xs'>AS</span>
        </div>
    ...
    <main className='min-h-screen p-6 max-w-4xl mx-auto'>
      <div className='flex justify-between items-center mb-8 print-hide'>
        ...
        <button onClick={() => window.print()}
          className='bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold px-6 py-3 rounded-xl transition'>
          Imprimir Todos
        </button>
      </div>
